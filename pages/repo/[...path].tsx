        ...
        <div className="repo-card">
          <div className="repo-header">
            ...
            <p className="repo-lead">
              For historical reasons, there are some small top level
              directories. Now the guidance is that new top level directories are
              for product (e.g. Chrome, Android WebView, Ash). Even if these
              products have multiple executables, the code should be in
              subdirectories of the product.
            </p>
            <p className="repo-note">
              If you found a bug, please file it at{" "}
              <a href="https://crbug.com/new">https://crbug.com/new</a>.
            </p>
          </div>
