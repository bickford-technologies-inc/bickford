...
bash ci/guards/ENVIRONMENT_PRECONDITION.sh && corepack enable && corepack prepare pnpm@10.28.0 --activate && pnpm install --frozen-lockfile --ignore-scripts --prefer-offline=false --strict-peer-dependencies
