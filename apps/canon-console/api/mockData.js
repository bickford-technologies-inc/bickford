...
export const modules = [
  {
    ...
    title: 'Canon Runtime',
    status: 'active',
    description: 'The Canon Runtime is the core enforcement engine that provides deterministic governance guarantees. It ensures that every AI operation complies with declared policies through cryptographic verification.',
    metrics: [
    ...
    actions: ['View Configuration', 'Run Diagnostics', 'Export Logs', 'Update Policy']
  },
...
export const alerts = [
  {
    ...
    message: 'Healthcare module policy state differs from canonical hash. Execution blocked.',
