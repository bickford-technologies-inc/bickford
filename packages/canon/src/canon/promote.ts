...
import type { CanonItemBase, CanonLevel, PromotionDecision, PromotionTests } from "@bickford/types";
...
export function promoteCanonItem(
  ...
  const decision: PromotionDecision & { reason: string } = {
 ...
 * Cannot skip levels
 */
export function validatePromotionPath(from: CanonLevel, to: CanonLevel): boolean {
